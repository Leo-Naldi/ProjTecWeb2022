...
function post_semantics_test(post_url, get_url, admin_auth, bodies) {
...
function delete_semantics_test(get_url, delete_url, admin_auth) {
    describe("Semantics Test", function(){
